        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
              Secure email summarization for law firms. Process privileged
              communications with private LLMs that never expose sensitive
              client information to the internet.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-card-foreground mb-4">
              Two-Box Privacy Model
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Email content never leaves the private LLM. Optional fact-checking
              uses redacted, template-based queries only.
            </p>
          </motion.div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Built for law firms with strict compliance requirements and zero
              tolerance for data exposure.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "No client data ever reaches external APIs. All processing stays within your controlled environment.",
              ...
              },
              {
                ...
                description:
                  "Every bullet point links to exact spans in the original email with byte-offset precision.",
                color: "text-blue-500",
              },
              {
                icon: Zap,
                ...
                description:
                  "Automatically flags liability caps, indemnity clauses, deadlines, and 11 other contract terms.",
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <p className="text-muted-foreground text-sm">
                Privacy-first email summarization
              </p>
            </div>
