...
export class BridgeController {
  ...
  async executeQuery(@Body() request: BridgeQueryRequestT): Promise<BridgeQueryResponseT> {
  ...
  @ApiResponse({ status: 200, description: 'Audit entries retrieved successfully' })
